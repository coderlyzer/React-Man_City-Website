  ...
  const submitForm = async (values) => {
    try {
      ...
      if (isOnTheList.docs.length >= 1) {
        showErrorToast('Sorry you are already on the newsletter list')
        setLoading(false)
        return false
      }
      ...
      showSuccessToast('Thank you for subscribing to the newsletter')
    } catch (err) {
      showErrorToast(err)
    }
  }
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="enroll_input">
              ...
              <div className="enroll_discl">
                Exclusive videos, latest news and many more surprises when you
